    ...
    <div className='left-menu'>
        <div style={{width: '100%'}}>
            <ul>
                ...
                {/* <li className='li-licenses expired'>Contros de custo</li>
                <li className='li-licenses expired'>Fabricantes</li>
                <li className='li-licenses expired'>Regras de licenciamento</li> */}
            </ul>
        </div>
    </div>
  )
